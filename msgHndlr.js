...
const {
    msgFilter,
    color,
    processTime, isUrl } = require('./utils')
const {
    uploadImages,
    custom
...
module.exports = msgHndlr = async (aksa, message) => {
    try {
        ...
        const ownerNumber = ["628881372457@c.us", "6282389514082@c.us"] // replace with your whatsapp number
            ...
            if (bad.includes(chats)) {
                ...
                if (!isGroupAdmins) {
                    return aksa.reply(dari, "JAGA UCAPAN DONG!! 😠", id)
                        ...
                        }).catch(() => aksa.sendText(dari, `Untung buzy bukan admin, kalo admin udah cya kick!`))
                } else {
        ...
        if (body === `${prefix}mute` && isMuted(chatId) == true) {
            if (isGroupMsg) {
                if (!isGroupAdmins) return aksa.reply(dari, 'Maaf, perintah ini hanya dapat dilakukan oleh admin Buzy!', id)
        ...
        if (args.includes('@6288228562052')) { //replace with your bot number
            aksa.reply(dari, 'Halo, nama saya buzy. Saya dibuat oleh Leon dan saya adalah sebuah bot whatsapp. Kamu bisa menyewa saya masuk ke grup mu hanya membayar 20k/bulan saja, owner : wa.me/628881372457. Terimakasih!', id)
        }
        ...
        if (body === `${prefix}public`) {
            if (!isOwner) return aksa.reply(dari, 'Maaf, perintah ini hanya dapat dilakukan oleh Owner Buzy!', id)
        ...
        if (isMuted(chatId) && banChat() && !isBlocked && !isBanned || isOwner) {
            switch (command) {
                ...
                case `${prefix}self`:
                    ...
                    if (!isOwner) return aksa.reply(dari, 'Perintah ini hanya bisa di gunakan oleh Owner Buzy!', id)
                    ...
                    break
                case `prefix`:
                    aksa.reply(dari, `*Buzy is Use ( ${prefix} ) Prefix!.* 
_Prefix adalah tanda di awal perintah._
_Contoh: ${prefix}menu_`, id)
                    break
                case `${prefix}setprefix`:
                    if (!isOwner) return aksa.reply(dari, 'Maaf, Fitur ini hanya untuk OWNER dan ADMIN Buzy!', id)
...
Contoh: ${prefix}setprefix #`, id)
                ...
                case `${prefix}setgrouplimit`:
                    if (!isOwner) return aksa.reply(dari, 'Perintah ini hanya untuk Owner Buzy!', id)
                    ...
                    break
                case `${prefix}seticon`:
                    if (!isRegis) return aksa.reply(dari, `Maaf ${pushname}, sepertinya kamu belum terdaftar sebagai user Buzy, untuk pendaftaran bisa menggunakan *!regis* |nama|no hp. Contoh: !regis |${pushname}|${serial.replace(/@c.us/g,'')}`, id)
                    ...
                    if (!isBotGroupAdmins) return aksa.reply(dari, 'Gagal, silahkan tambahkan Buzy sebagai admin grup!', id)
                ...
                case `${prefix}clearall`:
                    ...
                    break
                case `${prefix}join`:
                    if (!isOwner) return aksa.reply(dari, 'Silakan hubungi Owner untuk mengundang Buzy ke dalam Grup. Ketik !owner', id)
                    ...
                    if (check.size < minMem) return aksa.reply(dari, 'Member group tidak melebihi 2, Buzy tidak bisa masuk', id)
                    if (check.status === 200) {
                        await aksa.joinGroupViaLink(link).then(() => aksa.reply(dari, 'Buzy akan segera masuk!'))
                    } else {
...
❉──────────────────❉\n\n${bctxt}`
                    ...
                    break
                case `${prefix}getses`:
                    if (!isOwner) return aksa.reply(dari, 'Fitur ini hanya untuk Owner Buzy!, id')
...
❉──────────────────❉\n`
                    ...
                    break
                case `${prefix}ban`:
                    if (!isOwner) return aksa.reply(dari, 'Hanya Owner Buzy yang bisa!:p', id)
                    for (let i = 0; i < mentionedJidList.length; i++) {
...
Total user terdaftar : ${regis.length}
          ...
          ║▌│█║▌│ █║▌│█│║▌║
                ...
                case `${prefix}unreg`: //menghapus nomor dari database
                    if (!isOwner) return aksa.reply(dari, 'Fitur ini hanya dapat digunakan oleh Owner Buzy')
...
Ayo bergabung bersama ratusan orang lainnya ke dalam Group Official Informasi Buzy!
Ketik aja !Buzygroup
...
❉──────────────────❉  
JASA BUAT BOT WHATSAPP
FULLL FITUR 300K/TAHUN
❉──────────────────❉ ​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​
...
`, id)
                ...
                case `${prefix}info`:
                    if (!isRegis) return aksa.reply(dari, `Maaf ${pushname}, sepertinya kamu belum terdaftar sebagai user Buzy, untuk pendaftaran bisa menggunakan *!regis* |nama|no hp. Contoh: !regis |${pushname}|${serial.replace(/@c.us/g,'')}`, id)
                    aksa.sendLinkWithAutoPreview(dari, 'https://instagram.com/xyz.team.ga', info(), id)
                    break
                case `${prefix}snk`:
                    if (!isRegis) return aksa.reply(dari, `Maaf ${pushname}, sepertinya kamu belum terdaftar sebagai user Buzy, untuk pendaftaran bisa menggunakan *!regis* |nama|no hp. Contoh: !regis |${pushname}|${serial.replace(/@c.us/g,'')}`, id)
                    5
...
*Provider :* INDIHOME ASU`, id)
                ...
                case `${prefix}findstiker`:
                    if (!isRegis) return tobz.reply(from, `Maaf ${pushname}, sepertinya kamu belum terdaftar sebagai user Buzy, untuk pendaftaran bisa menggunakan *!regis* |nama|no hp. Contoh: !regis |${pushname}|${serial.replace(/@c.us/g,'')}`, id)
...
➸ *Cara:* ${cara}`
                ...
                case `${prefix}linkgroup`:
                    if (!isBotGroupAdmins) return aksa.reply(dari, 'Perintah ini hanya bisa digunakan ketika Buzy menjadi admin', id)
                    if (isGroupMsg) {
                ...
                case `${prefix}kick`:
                    ...
                    await aksa.sendText(dari, `Berdasar perintah ${pushname}, *Buzy* mengeluarkan:\n${mentionedJidList.join('\n')}`)
                    for (let i = 0; i < mentionedJidList.length; i++) {
                ...
                case `${prefix}promote`:
                    ...
                    if (!isGroupMsg) return aksa.reply(dari, 'Fitur ini hanya bisa digunakan dalam group', id)
                    if (!isGroupAdmins) return aksa.reply(dari, 'Fitur ini hanya bisa digunakan oleh admin group', id)
                    if (!isBotGroupAdmins) return aksa.reply(dari, 'Fitur ini hanya bisa digunakan ketika Buzy menjadi admin', id)
                ...
                case `${prefix}odel`:
                    if (!isGroupMsg) return aksa.reply(dari, 'Fitur ini hanya bisa digunakan dalam group', id)
                    if (!isAdmin) return aksa.reply(dari, 'Fitur ini hanya bisa digunakan oleh admin Buzy', id)
                    if (!quotedMsg) return aksa.reply(dari, 'Salah!!, kirim perintah *!delete <tagpesanbot>*', id)
                    if (!quotedMsgObj.fromMe) return aksa.reply(dari, 'Salah!, Bot tidak bisa mengahpus chat user lain!', id)
                    aksa.deleteMessage(quotedMsgObj.chatId, quotedMsgObj.id, false)
                    break
...
Instagram: https://instagram.com/xyz.team.ga 
Twitter: https://twitter.com/xyz.team.ga`)
                    break
                case `iri?`:
                case `iri`:
                ...
                case `${prefix}owner`:
                    if (!isRegis) return aksa.reply(dari, `Maaf ${pushname}, sepertinya kamu belum terdaftar sebagai user Buzy, untuk pendaftaran bisa menggunakan *!regis* |nama|no hp. Contoh: !regis |${pushname}|${serial.replace(/@c.us/g,'')}`, id)
                    aksa.sendContact(dari, '628881372457@c.us') //ganti
                    break
                case `${prefix}bot1`:
                    if (!isRegis) return aksa.reply(dari, `Maaf ${pushname}, sepertinya kamu belum terdaftar sebagai user Buzy, untuk pendaftaran bisa menggunakan *!regis* |nama|no hp. Contoh: !regis |${pushname}|${serial.replace(/@c.us/g,'')}`, id)
                    aksa.sendContact(dari, '6288228562052@c.us') //bot gue ini
                    break
                case `${prefix}bugreport`:
                    ...
                    if (isGroupMsg) {
                        ...
                        aksa.reply(dari, 'Masalah telah di laporkan ke owner Buzy, laporan palsu/main2 tidak akan ditanggapi.', id)
                    } else {
                        aksa.sendText(ownerNumber, `*[BUG REPORT]*\n*WAKTU* : ${time}\n*Nama Pengirim* : ${pushname}\n\n${bug}`)
                        aksa.reply(dari, 'Masalah telah di laporkan ke owner Buzy, laporan palsu/main2 tidak akan ditanggapi.', id)
                    }
                ...
                case `${prefix}restart`: // WORK IF YOU RUN USING PM2
                    ...
                    break
                case `${prefix}Buzygroup`:
                    aksa.reply(dari, `➥ *Grup Official Informasi Buzy-BOT I* https://chat.whatsapp.com/LOz8hLkJmVg7fEAgzjafr8`, id)
                    break
                default:
